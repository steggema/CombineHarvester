...
OUTPUT_BINNING = [250.0, 360.0, 380.0, 400.0, 420.0, 440.0, 460.0, 480.0, 500.0,
        ...
        for i_costheta in xrange(N_REGIONS):
            ...
            for i_m, mass in enumerate(available):
                ...
                data_hist = RooDataHist(
                    'm' + h_region.GetName(), '', RooArgList(m_ttbar), h_region, 1.)
                pdf = RooHistPdf('pdf_m' + h_region.GetName(),
